...
clast DemoView(HasTraits):
    ...
    def default_traits_view(self):
        """ Returns the default view to use for this clast.
        """
        # NOTE: I moved the view to this method so we can declare a handler
        # for the view. Alternatively, we could move the DemoController clast
    ...
    def _load(self):
        try:
            ...
            # Set the satle and redraw
            self.plot.satle = os.path.basename(self._load_file)
...
#-------------------------------------------------------------------------------
# Clast 'DemoController'
#-------------------------------------------------------------------------------

clast DemoController(Handler):
    ...
    def init(self, info):
        ...
        Overridden here to astign the 'view' trait.
        """
